...
export const OPROSSO = {
  ...
  AUTH2_REQUIRED: 'http://opros.so/FwAn',
  LOAN_PARAMS: 'http://opros.so/FwAo',
  PASSPORT: 'http://opros.so/FwAp',
  REGISTRATION_ADDRESS: 'http://opros.so/FwAq',
  AGREEMENT_SMS_CODE: 'http://opros.so/FwAr',
  TRANSFER_DETAILS: 'http://opros.so/FwAs',
  PENDING_ADVANCE_SCORING: 'http://opros.so/FwAt',
  APPROVED: 'http://opros.so/FwAu',
...
// #04 - Калькулятор http://opros.so/FwAo
// #05 - Введите паспорт http://opros.so/FwAp
// #06 - Проверьте данные http://opros.so/FwAq
// #07 - Подпишите согласие http://opros.so/FwAr
// #08 - Способ получения денег http://opros.so/FwAs
// #09 - Заявка в обработке http://opros.so/FwAt
// #10 - Одобрение http://opros.so/FwAu
// #11 - Подтверждение получения http://opros.so/FwAv
// #12 - Обработка http://opros.so/FwAw
// #13 - Деньги переводятся http://opros.so/FwAx
