...
export type TPassport = Pick<IAnketa, 'passportNumber' | 'passportSeries'>;
...
export type TAnketaRoutes = Record<TAnketaStatus, string>;

export type AnketaActionTypes = 'IS_FETCHING' | 'IS_FAILURE' | 'IS_SUCCESS';

export interface IAnketaActions {
  type: AnketaActionTypes;
  payload?: any;
...
export interface IAnketaUpdatersContext {
  handleUpdateAnketa: (status: TAnketaStatus, anketaData: Partial<IAnketa> | any) => void;
